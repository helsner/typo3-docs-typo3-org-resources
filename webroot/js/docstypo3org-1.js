...
$(document).ready(function () { 
	var ulnav = ''
		...
		+ '	</li>'
		+ '	<li><a href="https://docs.typo3.org/typo3cms">TYPO3 CMS</a>'
		+ '		<div class="nav-sub">'
		+ '			<div class="col">'
		...
		+ '			</div>'
		+ '			<div class="col">'
		+ '				<h4><a href="https://docs.typo3.org/typo3cms/Books.html">     Books         </a></h4>'
		+ '				<ul>'
		...
		+ '		</div>'
		+ '	</li>'
		+ '	<li><a href="https://docs.typo3.org/flow/TYPO3FlowDocumentation/">TYPO3 Flow</a>'
		+ '		<div class="nav-sub">'
		+ '			<div class="col">'
		+ '				<h4><a href="https://docs.typo3.org/flow/TYPO3FlowDocumentation/">TYPO3 Flow</a></h4>'
		+ '				<ul>'
		+ '					<li><a href="https://docs.typo3.org/flow/TYPO3FlowDocumentation/Quickstart/">           Quickstart                     </a></li>'
		+ '					<li><a href="https://docs.typo3.org/flow/TYPO3FlowDocumentation/TheDefinitiveGuide/">   The Definitive Guide           </a></li>'
		+ '					<li><a href="https://docs.typo3.org/flow/TYPO3FlowDocumentation/StyleGuide/Index.html"> TYPO3 Publications Style Guide </a></li>'
		+ '				</ul>'
		+ '			</div>'
		+ '		</div>'
		+ '	</li>'
		+ '	<li><a href="https://docs.typo3.org/neos/TYPO3NeosDocumentation/">TYPO3 Neos</a>'
		+ '		<div class="nav-sub">'
		+ '			<div class="col">'
		+ '				<h4><a href="https://docs.typo3.org/neos/TYPO3NeosDocumentation/">TYPO3 Neos</a></h4>'
		+ '				<ul>'
		+ '					<li><a href="https://docs.typo3.org/neos/TYPO3NeosDocumentation/GettingStarted/">   Getting Started   </a></li>'
		+ '					<li><a href="https://docs.typo3.org/neos/TYPO3NeosDocumentation/IntegratorGuide/">  Integrator Guide  </a></li>'
		+ '					<li><a href="https://docs.typo3.org/neos/TYPO3NeosDocumentation/DeveloperGuide/">   Developer Guide   </a></li>'
		+ '			</div>'
		+ '		</div>'
		+ '	</li>'
